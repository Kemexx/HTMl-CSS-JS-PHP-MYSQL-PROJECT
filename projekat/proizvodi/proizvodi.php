...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./ProizvodiStil.css">
...
<section id="boxes">
	<div class="container">
		<div class="box">
            <img src="./mob.jpg">
			<h3> <a href="mobiteli/mobiteli.php"> Mobiteli </a> </h3>
			
		</div>
		<div class="box">
			<img src="./slus.jpg">
			<h3> <a href="slusalice/slusalice.php"> Slušalice </a> </h3>
			
		</div>
       <div class="box">
			<img src="./blu.jpg">
			<h3> <a href="zvucnici/zvucnici.php"> Bluetooth zvučnici </a> </h3>
		</div>
